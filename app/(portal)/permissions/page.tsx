      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sticky top-8">
        ...
        <div className="lg:col-span-3 space-y-6">
              ...
              <AnimatePresence>
                {isAddingRole && (
                  <motion.div 
                    ...
                    exit={{ opacity: 0, y: -10 }}
                    className="p-4 bg-indigo-50/50 border border-indigo-100 rounded-2xl space-y-3"
                  >
                    <input 
                      autoFocus
                      type="text"
                    ...
                    <div className="flex gap-2">
                      <button onClick={handleAddRole} className="flex-1 bg-indigo-600 text-white rounded-lg py-2 text-[10px] font-black uppercase">Criar</button>
                      <button onClick={() => setIsAddingRole(false)} className="px-4 py-2 text-slate-400 hover:bg-white rounded-lg transition-all"><X size={16} /></button>
                    </div>
                  </motion.div>
                )}
              </AnimatePresence>
          ...
          <div className="bg-slate-900 text-white p-8 rounded-[2.5rem] relative overflow-hidden shadow-xl">
             ...
             <div className="absolute -right-4 -bottom-4 w-24 h-24 bg-indigo-600/20 blur-3xl rounded-full" />
          </div>
        </div>
        ...
        <div className="lg:col-span-9 space-y-6">
          {!currentRole ? (
            <div className="bg-white border border-slate-200 rounded-[3rem] p-20 flex flex-col items-center justify-center text-center space-y-4">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-[2.5rem] border border-slate-200 shadow-sm flex flex-col md:flex-row md:items-center gap-6">
                <div className="flex-1 space-y-1">
                  {selectedRoleId === 'admin' ? (
                    ...
                    <div className="flex items-center gap-3">
                      <input 
                        ...
                        className="text-lg font-black text-slate-800 uppercase tracking-tight bg-transparent border-none p-0 focus:ring-0 outline-none hover:bg-slate-50 transition-all rounded-lg px-2"
                      />
                      <button 
                  ...
                  <p className="text-xs text-slate-400 font-medium">Configurando {currentRole.permissions.length} acessos ativos</p>
                </div>
                  ...
                  {filteredGroups.map((group) => {
                    ...
                    return (
                      <motion.div 
                        ...
                        className="bg-white border border-slate-200 rounded-[2.5rem] shadow-sm flex flex-col overflow-hidden"
                      >
                          ...
                          {selectedRoleId !== 'admin' && (
                            <button 
                              ...
                              className={cn(
                                ...
                                allEnabled ? "text-red-500 hover:text-red-700" : "text-indigo-600 hover:text-indigo-800"
                              )}
                            >
                            ...
                            return (
                              ...
                              >
                                <div className={cn(
                                  ...
                                  isEnabled ? "bg-indigo-600 text-white shadow-xl shadow-indigo-100" : "bg-white border border-slate-200 text-slate-300"
                                )}>
                                ...
                                <div className="flex-1 pr-6">
                                  <p className={cn(
                                    ...
                                    isEnabled ? "text-slate-800" : "text-slate-400 group-hover:text-slate-600"
                                  )}>
                                    {perm.label}
                                  </p>
            ...
            >
              <div className="space-y-6 text-center">
                ...
                <div className="flex gap-4 pt-2">
                  <button 
                    onClick={() => setRoleToDelete(null)}
                    className="flex-1 px-6 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-slate-600 hover:bg-slate-50 transition-all border border-slate-100"
                  >
                    Cancelar
                  </button>
                  <button 
