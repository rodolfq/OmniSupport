    ...
    <div className={cn("relative inline-flex min-w-0", className?.includes("w-full") && "w-full", className?.includes("flex-1") && "flex-1")}>
      ...
      <button
        ...
        className={cn(
          ...
          "focus-visible:ring-4 focus-visible:ring-indigo-500/10 focus-visible:border-indigo-500",
          "disabled:cursor-not-allowed disabled:opacity-60",
          className,
        )}
      >
        <span className="min-w-0 flex-1 truncate">{selectedOption?.label}</span>
        <ChevronDown size={15} className={cn("shrink-0 text-slate-400 transition-transform duration-200", open && "rotate-180 text-indigo-500")} />
      </button>
          ...
          {open && (
            <>
              ...
              <motion.div
                ...
                className="fixed overflow-y-auto rounded-xl border border-slate-200 bg-white p-1.5 shadow-2xl shadow-slate-900/15"
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        selected ? "font-bold text-indigo-600" : "font-medium text-slate-700",
