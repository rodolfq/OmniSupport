...
// 9 dígitos (celular, "9" opcional aqui), com/sem +55 na frente e com/sem
// separador (espaço, hífen, parênteses). Cobre "11999999999",
// "11 9 9999-9999", "(11) 99999-9999", "+55 11 99999-9999" etc — mesma
// ideia solta (com falsos positivos aceitáveis) que o WhatsApp Web usa pra
// virar número em algo clicável dentro da mensagem. Lookaround em vez de
// \b nas pontas: \b não separa dígito de dígito, então sem isso um trecho
// de 15 dígitos seguidos casava só uma fatia de 10/11 no meio.
