...
<StyledSelect
            ...
            <div className="flex-1 overflow-y-auto -mx-2 px-2">
              {loading ? (
                ...
                <p className="text-center py-8 text-slate-400">Nenhum ticket interno encontrado</p>
              ) : (
                <div className="space-y-2">
                  {allTickets.map((t) => (
                    ...
                    >
                      ...
                      <p className="text-xs text-slate-500 mt-1">{t.teamId || 'Sem equipe'}</p>
                    </button>
                  ))}
                </div>
              )}
            ...
            <div className="flex justify-end mt-4 pt-4 border-t border-slate-100">
              <button
                onClick={onClose}
                className="px-4 py-2 rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-50 transition-all text-sm font-bold"
              >
                Cancelar
              </button>
            </div>
