...
import { GiroDayView } from '@/app/(portal)/giro/giro-day-view';
import { GiroConfigView } from '@/app/(portal)/giro/giro-config-view';

type Tab = 'day' | 'config';

/**
 * Conteúdo da aba "Giro de Atendimento" em Configurações. Era a página
 * /giro — migrada pra dentro de Configurações (ver
