...
/**
 * Conteúdo da aba "Hotfixes" em Configurações. Era a página /hotfixes —
 * migrada pra dentro de Configurações (ver app/(portal)/settings/page.tsx);
 * a rota antiga agora só redireciona pra cá.
 */
