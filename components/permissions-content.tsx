...
// função de mesmo nome em components/team-content.tsx.
...
const permissionGroups = [
  ...
  },
  {
    ...
    permissions: [
      { id: Permission.GIRO_VIEW, label: 'Ver o Giro', desc: 'Permite abrir o Giro de Atendimento, o botão de status em Chamados e no Dashboard, e registrar/concluir o próprio atendimento do dia' },
...
/**
 * Conteúdo da aba "Equipes & Permissões" em Configurações. Era a página
 * /permissions — migrada pra dentro de Configurações (ver
 * app/(portal)/settings/page.tsx); a rota antiga agora só redireciona pra cá.
 */
export function PermissionsContent() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-300">
      {/* Header Bar */}
