...
-- Registro RÍGIDO de criação de usuários (gatilho em profiles + tabela só-inserção)
-- — ver migrations/user_creation_log.sql para a explicação completa.
...
-- Cursor do rodízio por fila (quem recebeu a última distribuição automática) — ver
-- migrations/queue_rotation_cursor.sql.
